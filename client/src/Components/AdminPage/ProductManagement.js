...
function ProductManagement(props) {
    ...
    const submitItem = () => {
        ...
        Axios.post(`${base_url}/getMaxID`).then(res => {
            ...
            Axios.post(`${base_url}/addItem`,{data: {itemName, id: max, description, price, available, image, category, isAge, isPedigree, sale} }).then(result => {
                console.log(result)
